...
// Ensures routes match regardless of whether /api prefix was stripped by a rewrite
app.use((req: Request, res: Response, next: NextFunction) => {
  if (req.url && !req.url.startsWith('/api') && !req.url.startsWith('/spadmin') && !req.url.startsWith('/assets') && !req.url.startsWith('/@')) {
...
// Ensure database initialization on serverless / process start
